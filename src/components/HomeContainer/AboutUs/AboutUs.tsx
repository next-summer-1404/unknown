...
const AboutUs = () => {
  return (
    <div className="bg-[#2d2d2d]">
      {" "}
      <div className="flex flex-col gap-7 justify-center bg-[#232323] rounded-b-[60px] w-full  py-10 px-7">
          ...
          <div className="relative bg-[#2D2D2D] rounded-3xl h-full p-4 ">
            ...
            <div className="relative rounded-3xl px-3 h-full bg-[#7569FF] ">
              ...
              <p className="pt-10 pb-3">
                ...
                برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو د...
              </p>
            </div>
          </div>
