...
const LoginModal: React.FC<LoginModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(86,86,86,0.8)] ">
      <div className="bg-[#2a2a2a] rounded-lg p-6 w-96 text-center text-white">
