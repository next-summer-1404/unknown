    ...
    <div className="w-full h-auto border border-amber-300">
      <div className="w-11/12 m-auto bg-[#2A2A2A] p-4 rounded-xl border border-blue-500 flex flex-wrap items-center gap-4">
        <div className="w-48 flex flex-col relative">
          ...
          <select
            className="w-full b text-white p-2 rounded-lg appearance-none pr-8 border border-[#AAAAAA]"
            defaultValue=""
          >
        ...
        <div className="w-48 flex flex-col relative ">
          ...
          <div className="relative">
            <select
              className="w-full  text-white p-2 rounded-lg appearance-none pr-10 border border-[#AAAAAA]"
              defaultValue=""
            >
              <option value="" disabled hidden>
                جدیدترین‌ها
      ...
      <div className="w-11/12 m-auto h-96 mt-5 bg-[#2A2A2A] p-4 rounded-xl border border-red-500"></div>
    </div>
  );
};
