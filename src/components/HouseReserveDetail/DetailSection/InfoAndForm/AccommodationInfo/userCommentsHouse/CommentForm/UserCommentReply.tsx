...
const UserCommentReply = ({ commentData }: UserCommentsHouseProps) => {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="flex justify-between pb-5">
        ...
        <div className="w-[68%] flex items-center gap-5">
          ...
          <button
            type="submit"
            className="w-[22%] h-9 flex items-center justify-center gap-1 bg-[#8CFF45] rounded-xl cursor-pointer text-[#363636] shadow-[0px_8px_16px_0px_#8CFF4514]"
          >
