import { CalendarDaysIcon, ChatBubbleOvalLeftEllipsisIcon, CurrencyDollarIcon, NewspaperIcon, PhoneArrowDownLeftIcon } from '@heroicons/react/24/outline'
...
const InfoCall = () => {
  return (
    <div className='w-3/12 h-auto border border-[#565656] bg-[#393939] rounded-2xl pb-5'>
          ...
          <p className='text-white text-center p-5'>محمد رضا ساداتی</p>
          <div className='w-4/5 mx-auto h-10 flex items-center gap-1 justify-center'>
            <CalendarDaysIcon className='w-5 h-5 text-[#AAAAAA]'/>
            <p className='text-[#AAAAAA] text-center'>12 مرداد - 1401 / 12:33</p>
          </div>
          <div className='w-full  flex gap-2 mt-10 mx-3'>
            <CurrencyDollarIcon className='w-5 h-5 text-[#AAAAAA]'/>
            <p className='text-[#AAAAAA] '>قیمت رهن از:</p><span className='text-[#8CFF45] mr-10 text-xl'>100000000 ت</span>
          </div>
           <div className='w-full  flex gap-2 mt-5 mx-3'>
            <NewspaperIcon className='w-5 h-5 text-[#AAAAAA]'/>
            <p className='text-[#AAAAAA] '>قیمت اجاره از:</p><span className='text-[#8CFF45] mr-10 text-xl'>100000000 ت</span>
          </div>
